...
| [SPEC-053](SPEC-053-marking-walk-claims.md) | The Marking Walk's Restated Claims, and the Gate That Would Have Caught Them | Completed | SPEC-042, SPEC-052 |
| [SPEC-054](SPEC-054-one-lifecycle-owner.md) | One Lifecycle Owner for Both Delivery Paths | In Progress | SPEC-030, SPEC-033, SPEC-035, SPEC-040, SPEC-044, SPEC-045, SPEC-046, SPEC-050 |
| [SPEC-055](SPEC-055-assembly-decoration-and-echo-residue.md) | Assembly, Decoration and Echo Residue | Completed | SPEC-017, SPEC-020, SPEC-025, SPEC-029, SPEC-037 |

## Arcs (build order)

Group related specs and record the order to build them in. Keep this section: a spec split for size
(`docs/process/authoring-a-spec.md`) always records its order here, even if you group nothing else.
...
- **Assembly, decoration and echo residue:** SPEC-055 — the five runtime findings of the second
  ...
  *wrapped* — and the spec recommends refusing, because a refusal can later be lifted into a wrap
  ...
  its own, SPEC-056, built after SPEC-055 and replacing its FR-003.

...
- [The supported-Python versions have one authority — the CI matrix — and every restatement is bound to it](#the-supported-python-versions-have-one-authority--the-ci-matrix--and-every-restatement-is-bound-to-it)

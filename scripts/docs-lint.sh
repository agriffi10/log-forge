...
#   OUT: docs/specs, docs/spec-delivery, docs/templates, docs/audits and docs/release-notes
#        — FROZEN RECORDS, not standing rules. An
...
# directory that does not exist yet, is covered without anyone remembering to list it.
{
  ...
  if [ -d .github ]; then find .github -type f \( -name '*.yml' -o -name '*.yaml' \) -print | sort; fi
    ...
    # FROZEN RECORDS, excluded by tree. Another kind of record — an archive, a changelog —

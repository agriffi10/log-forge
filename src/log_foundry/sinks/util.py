...
class StderrSink(StdoutSink):
    """The :class:`~log_foundry.sinks.stdout.StdoutSink` shape, defaulting to ``sys.stderr`` (FR-004).
...
class MemorySink:
    """A :class:`~log_foundry.sinks.base.Sink` that collects events into an in-process list (FR-006).
